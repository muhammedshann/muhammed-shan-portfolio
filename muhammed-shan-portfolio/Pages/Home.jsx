    ...
    <div className={`flex flex-col min-h-screen transition-colors duration-500 ${isDarkMode
      ...
      <main className="flex-grow max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 w-full py-12 md:py-0">
        ...
        <div className="flex-1 space-y-6 order-2 md:order-1 text-center md:text-left">
          {/* Status Badge */}
          <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-[12px] font-medium transition-colors ${isDarkMode ? 'border-[#222] bg-[#111] text-blue-400' : 'border-neutral-200 bg-white text-blue-600 shadow-sm'
            }`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
            <button
              ...
              className={`group flex items-center justify-center gap-2 px-8 py-3 text-[14px] font-medium rounded-xl transition-all ${isDarkMode
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 px-8 py-3 border text-[14px] font-medium rounded-xl transition-all ${isDarkMode
        ...
        <div className="flex-1 flex justify-center md:justify-end order-1 md:order-2 w-full max-w-[320px] md:max-w-none">
          <div className={`relative aspect-square w-full md:w-[400px] overflow-hidden rounded-[2rem] border transition-all duration-500 ${isDarkMode
